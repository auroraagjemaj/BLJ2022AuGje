...
public class Exercise2 {
    ...
    public static void rows() {
        ...
        try {
            File exc1 = new File("C:\\Users\\Aurora\\BLJ2022AuGje\\JAVA\\KW06\\Bewerter\\src\\Aufgabe2.txt");
    ...
    public static void column() {
        try {
            BufferedReader brTest = new BufferedReader(new FileReader("C:\\Users\\Aurora\\BLJ2022AuGje\\JAVA\\KW06\\Bewerter\\src\\Aufgabe2.txt"));
    ...
    public static void order() throws IOException {
        BufferedReader brTest = new BufferedReader(new FileReader("C:\\Users\\Aurora\\BLJ2022AuGje\\JAVA\\KW06\\Bewerter\\src\\Aufgabe2.txt"));
        String text = brTest.readLine();
        if(text.equals(" last_name  |  salary")){
            mark++;
